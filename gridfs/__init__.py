...
class GridFS(object):
    ...
    def get_version(self, callback, filename=None, version=-1, **kwargs):
    ...
    def get_last_version(self, callback, filename=None, **kwargs):
    ...
    def delete(self, file_id, callback):
    ...
    def exists(self, callback, document_or_id=None, **kwargs):
